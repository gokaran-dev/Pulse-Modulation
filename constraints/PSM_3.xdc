...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {test2}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {load_volt_regulation}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {drdy_out}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {test1}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {test2}];  # "JA7"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {APSM_out}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {PSM_out}];  # "JB2"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {reset_in}];  # "SW0"
